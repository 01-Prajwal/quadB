        ...
        <>
            ...
            <main class="ticket-system">
               ...
               <path d="M86.514 38.058V17.96H69.291v20.098H49.193v17.223h20.079v20.106h17.23V55.281h20.11V38.058H86.514z" fill="#fff"/>
                            ...
                            <div class="route">
                                <h2 style={{color:"black"}}>HAPPY</h2>
    
                                <FontAwesomeIcon icon={faTicket} style={{ marginRight: "10px" }} />
                                <h2 style={{color:"black"}}>MOVIE</h2>
                            </div>
                            <div class="details">
                                <div class="item">
                                    <span>Movie</span>
                                ...
                                <div class="item">
                                    {/* <span>Primiere</span>
                  <h3>{data.premiered}{' '}{data.schedule.time}</h3> */}
                  <span>Primiere</span>
                                ...
                                <div class="item">
                                    <span>Runtime</span>
                                    <h3>{data.runtime ? `${data.runtime} mins` : "No Info"}</h3>
                                </div>
                                {/* <div class="item">
                                    <span>Luggage</span>
                                    <h3>Hand Luggage</h3>
